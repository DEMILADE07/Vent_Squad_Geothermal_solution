...
from src.paths import DATA_PROCESSED, WELL_LOGS_PARQUET
from src.targets import build_target_tvd
from src.wells_io import coverage_table, load_all
...
def main() -> None:
    ...
    log.info("wrote %s (%d rows)", WELL_LOGS_PARQUET.name, len(logs))
